// Server-side port of src/utils/calculateScenario.ts, used by agent tools.
// Pure function, no runtime deps — kept in sync manually (both files share the same constants).
